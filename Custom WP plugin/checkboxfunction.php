...
add_action( 'wp_ajax_nopriv_custom_checkbox_action', 'custom_checkbox_action' ); 
    ...
    if($checkboxname && $checkboxvalue && $usert_id){
		...
		if($wpdb->num_rows > 0 ){
		   $wpdb->query( $wpdb->prepare("UPDATE $table_name 
             ...
             WHERE checkboxname = %s and pageid=%s and userid=%s",$checkboxvalue,$current_date,$checkboxname,$current_page_id,$usert_id)
           );
		}else{				
